...
// Field definitions and sample eligibility criteria
...
/**
 * Sample eligibility criteria for demo/testing
 */
export const mockEligibilityCriteria: EligibilityCriteria[] = [
    {
        id: 'criteria-001',
        name: 'DOD Project Requirements',
        description: 'Additional requirements for Department of Defense projects',
        isActive: true,
        rootGroup: {
            id: 'group-001',
            type: 'GROUP',
    ...
    },
    {
        id: 'criteria-002',
        name: 'Texas Workers',
        description: 'Criteria for workers based in Texas',
        isActive: true,
        rootGroup: {
            id: 'group-002',
            type: 'GROUP',
            ...
            rules: [
                {
                    id: 'rule-002-1',
                    type: 'FIELD_RULE',
                    fieldId: 'person.homeAddress.state',
                    operator: 'equals',
                    value: 'TX',
                },
                {
                    id: 'rule-002-2',
                    type: 'FIELD_RULE',
                    fieldId: 'assignment.workLocation.state',
                    operator: 'equals',
                    value: 'TX',
                },
            ],
    ...
    {
        id: 'criteria-003',
        name: 'Union Electricians',
        description: 'Requirements specific to union electricians',
        isActive: true,
        rootGroup: {
            id: 'group-003',
            type: 'GROUP',
    ...
    {
        id: 'criteria-004',
        name: 'Complex Nested Criteria',
        description: 'Example with nested rule groups',
        isActive: true,
        rootGroup: {
            id: 'group-004',
            type: 'GROUP',
    ...
    },
    {
        ...
        description: 'Example using custom SQL rule',
        isActive: true,
        rootGroup: {
            id: 'group-005',
            type: 'GROUP',
            ...
            rules: [
                {
                    id: 'sql-rule-001',
                    type: 'SQL_RULE',
                    name: 'Prior Experience Check',
                    description: 'Check if worker has prior experience on similar projects',
                    sqlQuery: `SELECT 1 FROM worker_history wh
WHERE wh.worker_id = :worker_id
AND wh.project_type = :project_type
AND wh.experience_years >= 2`,
                },
            ],
        },
        createdAt: '2025-01-01T00:00:00Z',
 ...
 */
export const getEligibilityCriteriaById = (id: string): EligibilityCriteria | undefined => {
    return mockEligibilityCriteria.find(criteria => criteria.id === id);
};
